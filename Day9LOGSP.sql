...
MariaDB [CSD2204S18]> select first_name,last_name,department_id where department_id =(select department_id FROM departments where department_name like 'IT%');
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'where department_id =(select department_id FROM departments where department_nam' at line 1
MariaDB [CSD2204S18]> select first_name,last_name,department_id where department_id IN (select department_id FROM departments where department_name like 'IT%');
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'where department_id IN (select department_id FROM departments where department_n' at line 1
...
MariaDB [CSD2204S18]> select first_name,last_name  from employees where employee_id IN (select manager_id FROM EMPLOYEES where manager_id!=0);
+------------+-----------+
| first_name | last_name |
+------------+-----------+
| Steven     | King      |
...
MariaDB [CSD2204S18]> select first_name,last_name,salary,job_id  from employees from salary = (select min_salary from jobs where employee.job_id=jobs.job_id);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from salary = (select min_salary from jobs where employee.job_id=jobs.job_id)' at line 1
MariaDB [CSD2204S18]> select first_name,last_name,salary,job_id  from employees from salary = (select min_salary from jobs where employees.job_id=jobs.job_id);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from salary = (select min_salary from jobs where employees.job_id=jobs.job_id)' at line 1
MariaDB [CSD2204S18]> select first_name,last_name,salary,job_id  from employees from employees.salary = (select min_salary from jobs where employee.job_id=jobs.job_id);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from employees.salary = (select min_salary from jobs where employee.job_id=jobs.' at line 1
MariaDB [CSD2204S18]> select first_name,last_name,salary,job_id  from employees from employees.salary IN (select min_salary from jobs where employee.job_id=jobs.job_id);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from employees.salary IN (select min_salary from jobs where employee.job_id=jobs' at line 1
MariaDB [CSD2204S18]> select avg(salary) from employees;
+-------------+
| avg(salary) |
+-------------+
...
MariaDB [CSD2204S18]> select first_name,last_name,salary,department_id from employees where salary(select avg(salary) from employees) AND deprtment_id IN(select department_id FROM departments where department_name like 'IT%');
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'select avg(salary) from employees) AND deprtment_id IN(select department_id FROM' at line 1
...
MariaDB [CSD2204S18]> select first_name,last_name,salary,job_id  from employees from employees.salary = (select min_salary from jobs where employees.job_id=jobs.job_id);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from employees.salary = (select min_salary from jobs where employees.job_id=jobs' at line 1
